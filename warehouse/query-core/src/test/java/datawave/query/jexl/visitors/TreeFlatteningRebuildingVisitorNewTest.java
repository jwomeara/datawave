...
public class TreeFlatteningRebuildingVisitorNewTest {
    ...
    public void dontFlattenASTDelayedPredicateAndTest() throws Exception {
        ...
        JexlNode node = TreeFlatteningRebuildingVisitorNew.flatten(JexlASTHelper.parseJexlQuery(query));
    ...
    private void testFlatten(String expected, String original) throws ParseException {
        ...
        ASTJexlScript flattened = TreeFlatteningRebuildingVisitorNew.flattenAll(originalScript);
    ...
    public void depthNoStackTraceOrTest() throws Exception {
        ...
        Assert.assertNotNull(TreeFlatteningRebuildingVisitorNew.flattenAll(new Parser(new StringReader(";")).parse(new StringReader(
