...
public class NYCTLCColumnBasedHandlerTest {
    ...
    public void testNyctlc01() throws Exception {
        ...
        ColumnBasedHandlerTestUtil.processEvent(abstractHandler, null, event, 35, 10, 0, 0, false);
        ...
        ColumnBasedHandlerTestUtil.processEvent(abstractHandler, null, event, 36, 10, 0, 0, false);
